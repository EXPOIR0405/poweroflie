...
export default function FloatingMenu() {
  return (
    <div className="fixed right-4 bottom-4 flex flex-col space-y-3 max-w-[90px] z-40">
      <button className="floating-btn group">
        <div className="flex flex-col items-center">
          <BsChatSquareText className="w-6 h-6 mb-1" />
          <span className="text-xs">당원게시판</span>
        </div>
      </button>
      <button className="floating-btn group">
        <div className="flex flex-col items-center">
          <BsPersonPlus className="w-6 h-6 mb-1" />
          <span className="text-xs">당원가입</span>
        </div>
      </button>
      <button className="floating-btn group">
        <div className="flex flex-col items-center">
          <BsGift className="w-6 h-6 mb-1" />
          <span className="text-xs">후원하기</span>
        </div>
      </button>
